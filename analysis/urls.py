...
urlpatterns = [
    ...
    path('crops/rating/minimum', views.CropRatingLowView.as_view(), name='crop-rating-minimum'),
    ...
    path('trees/rate/average', views.AverageTreeRateView.as_view(), name='average-rate-rate'),
